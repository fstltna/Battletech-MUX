...
/* 
   ...
   $Id: template.c 1.17 04/05/09 23:26:18+02:00 thomas@suisite-dev.xs4all.nl $
...
char *cargo[] = {
    ...
    "Ammo_AC2_(Flechette)",
    "Ammo_AC5_(Flechette)",
    "Ammo_AC10_(Flechette)",
    "Ammo_AC20_(Flechette)",
    "Ammo_LAC2_(Flechette)",
    "Ammo_LAC5_(Flechette)",
    "Ammo_AC2_(Incendiary)",
    "Ammo_AC5_(Incendiary)",
    "Ammo_AC10_(Incendiary)",
    "Ammo_AC20_(Incendiary)",
    "Ammo_LAC2_(Incendiary)",
    "Ammo_LAC5_(Incendiary)",
    "Ammo_AC2_(Precision)",
    "Ammo_AC5_(Precision)",
    "Ammo_AC10_(Precision)",
    "Ammo_AC20_(Precision)",
    "Ammo_LAC2_(Precision)",
    "Ammo_LAC5_(Precision)",
    "Ammo_LR_DFM",
    "Ammo_SR_DFM",
    "Ammo_SLRM",
    "Ammo_ELRM",
...
int cargoweight[] = {
    1024,			/* Ammo_LBX2 */
    1024,			/* Ammo_LBX5_(LBX) */
    1024,			/* Ammo_LBX10_(LBX) */
    1024,			/* Ammo_LBX20_(LBX) */
    1024,			/* Ammo_LRM */
    1024,			/* Ammo_SRM */
    1024,			/* Ammo_SSRM */
    1024,			/* Ammo_LRM_(NARC) */
    1024,			/* Ammo_SRM_(NARC) */
    1024,			/* Ammo_SSRM_(NARC) */
    1024,			/* Ammo_LRM_(Artemis) */
    1024,			/* Ammo_SRM_(Artemis) */
    1024,			/* Ammo_SSRM_(Artemis) */
    102,			/* Petroleum */
    102,			/* Phosphorus */
    102,			/* Hydrogen */
    204,			/* Gold */
    ...
    20,				/* DS_Fuel */
    2,				/* VTOL_Fuel */
    1024,			/* Ammo_LRM_(Swarm) */
    1024,			/* Ammo_LRM_(Swarm1) */
    1024,			/* Ammo_SRM_(Inferno) */
    1024,			/* XXL_Engine */
    2048,			/* Compact_Engine */
    6,				/* HD_Armor */
    4,				/* RE_Internals */
    ...
    7,				/* HVY_FF_Armor */
    1,				/* LT_FF_Armor */
    1024,			/* Ammo_iNARC_(Explosive) */
    1024,			/* Ammo_iNARC_(Haywire) */
    1024,			/* Ammo_iNARC_(ECM) */
    1024,			/* Ammo_iNARC_(Nemesis) */
    1024,			/* Ammo_AC2_(AP) */
    1024,			/* Ammo_AC5_(AP) */
    1024,			/* Ammo_AC10_(AP) */
    1024,			/* Ammo_AC20_(AP) */
    1024,			/* Ammo_LAC2_(AP) */
    1024,			/* Ammo_LAC5_(AP) */
    1024,			/* Ammo_AC2_(Flechette) */
    1024,			/* Ammo_AC5_(Flechette) */
    1024,			/* Ammo_AC10_(Flechette) */
    1024,			/* Ammo_AC20_(Flechette) */
    1024,			/* Ammo_LAC2_(Flechette) */
    1024,			/* Ammo_LAC5_(Flechette) */
    1024,			/* Ammo_AC2_(Incendiary) */
    1024,			/* Ammo_AC5_(Incendiary) */
    1024,			/* Ammo_AC10_(Incendiary) */
    1024,			/* Ammo_AC20_(Incendiary) */
    1024,			/* Ammo_LAC2_(Incendiary) */
    1024,			/* Ammo_LAC5_(Incendiary) */
    1024,			/* Ammo_AC2_(Precision) */
    1024,			/* Ammo_AC5_(Precision) */
    1024,			/* Ammo_AC10_(Precision) */
    1024,			/* Ammo_AC20_(Precision) */
    1024,			/* Ammo_LAC2_(Precision) */
    1024,			/* Ammo_LAC5_(Precision) */
    1024,			/* Ammo_LR_DFM */
    1024,			/* Ammo_SR_DFM */
    1024,			/* Ammo_SLRM */
    1024,			/* Ammo_ELRM */
